              ...
              <div className="flex flex-col items-center gap-[30px] py-6 sm:py-8 flex-grow">
                <div className="flex flex-col items-start gap-2 md:px-6 px-6 text-start w-full flex-grow">
                  ...
                  <div className="py-8 flex justify-center w-full">
                    <Button variant='outline' className="w-full sm:w-[300px] md:w-[640px] lg:w-full xl:w-[720px] items-center justify-center text-center cursor-pointer whitespace-nowrap rounded-lg font-semibold text-[16px]">+ Add new link</Button>
                  </div>
                  <div className="flex flex-col items-center justify-center gap-5 rounded-[12px] bg-add-new px-14 py-[62px] md:p-5 flex-grow">
                    <Image
                      src={started}
                      width={250}
                      height={160}
